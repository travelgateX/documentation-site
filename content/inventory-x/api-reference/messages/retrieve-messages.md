...
pagetitle = "Retrieve Messages"
description = "List of Inventory-X retrieve messages"
icon = "fa-exchange" 
weight = 2
alwaysopen = false
isDirectory = false
...
***Retrieve*** messages are used by the Providers to retrieve the data currently loaded in the TGX system.
