...
pagetitle = "Notify Messages"
description = "List of Inventory-X notify messages"
icon = "fa-exchange" 
weight = 1
alwaysopen = false
isDirectory = false
...
Notify messages are used by providers to load product and data into the TGX database.
