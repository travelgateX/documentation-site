...
| ProviderCode				| 0..1 		| String	| Internal code established by the supplier (see [MetaData](/legacy/hotel-suppliers/methods/messages/static-methods/metadata/)). |
...
supplier (see [MetaData](/legacy/hotel-suppliers/methods/messages/static-methods/metadata/)).
