...
| Price      				| 0..1       	|		| Fee for the cancellation. (see [MetaData](/legacy/hotel-suppliers/methods/messages/static-methods/metadata/) in order to verify if supplier informs of it).						|
