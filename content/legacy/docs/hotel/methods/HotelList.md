...
| ProviderCode				| 0..1 		| String	| Internal code established by the supplier (see [MetaData](https://docs.travelgatex.com/legacy/docs/hotel/methods/metadata/)). |
...
supplier (see [MetaData](https://docs.travelgatex.com/legacy/docs/hotel/methods/metadata/)).
