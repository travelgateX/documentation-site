...
✅  Description `Plugin Type` on type `PluginType` has changed to `Plugin Type. https://docs.travelgatex.com/hotelx/plugins/overview/`

✅  Description `Plugin Step Type` on type `PluginStepType` has changed to `Plugin Step Type. https://docs.travelgatex.com/hotelx/plugins/overview/`
