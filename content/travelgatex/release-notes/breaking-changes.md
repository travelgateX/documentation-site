...
- Deprecated `distribute` from `AddOns`. Reason: You can find it in distribution AddOn. Expected deprecation on undefined (Days left: unknown).
{{% / release-notes-container %}}
### 2018-08-03
{{% release-notes-container type="d"%}}
- Deprecated `organization` from `PaymentXBookingInfoFilterInput`. Reason: Please use PaymentXBookingInfoCriteriaInput. Expected deprecation on 2018-08-03 (Days left: 110).
- Deprecated `pointOfSaleCode` from `PaymentXBookingInfoFilterInput`. Reason: Please use PaymentXBookingInfoCriteriaInput. Expected deprecation on 2018-08-03 (Days left: 110).
- Deprecated `bookingReference` from `PaymentXBookingInfoFilterInput`. Reason: Please use PaymentXBookingInfoCriteriaInput. Expected deprecation on 2018-08-03 (Days left: 110).
{{% / release-notes-container %}}
### 2018-07-09
...
### 2018-03-19
{{% release-notes-container type="d"%}}
- Deprecated `connectUser` from `HotelSettingsInput`. Reason: Redundant.. Expected deprecation on 2018-03-19 (Item will be removed on the next update).
{{% / release-notes-container %}}
### 2017-12-12
{{% release-notes-container type="d"%}}
- Deprecated `useContext` from `HotelSettingsInput`. Reason: Redundant.. Expected deprecation on 2017-12-12 (Item will be removed on the next update).
{{% / release-notes-container %}}
### 2017-11-21
{{% release-notes-container type="d"%}}
